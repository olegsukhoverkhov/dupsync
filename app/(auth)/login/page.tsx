      ...
      <div className="relative w-full max-w-md mx-auto px-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/80 backdrop-blur-sm p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3.5 text-sm font-medium text-white hover:bg-white/10 transition-colors"
          >
        ...
        <p className="mt-6 text-center text-xs text-slate-600">
          ...
          and{" "}
          <Link href="/privacy" className="text-slate-500 hover:text-slate-400 underline">
            Privacy Policy
          </Link>
        </p>
      </div>
