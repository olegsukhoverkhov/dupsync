...
const TRANSLATIONS = {
  ...
  hi: {
    title: "DubSync सुविधाएं — वॉइस क्लोनिंग, लिप सिंक, AI डबिंग",
    description:
      "DubSync की AI डबिंग सुविधाएं: वॉइस क्लोनिंग, लिप सिंक, 30+ भाषाएं, मल्टी-स्पीकर डिटेक्शन और API।",
    h1: "AI वीडियो डबिंग सुविधाएं",
    h1Highlight: "क्रिएटर्स और टीमों के लिए",
    subtitle:
      "अपना वीडियो अपलोड करें, भाषाएं चुनें, और DubSync को वॉइस क्लोनिंग, लिप सिंक और अनुवाद संभालने दें।",
  ...
  ar: {
    title: "ميزات DubSync — استنساخ الصوت، مزامنة الشفاه، دبلجة AI",
    description:
      "استكشف ميزات الدبلجة بالذكاء الاصطناعي: استنساخ الصوت، مزامنة الشفاه، 30+ لغة، كشف متعدد المتحدثين وAPI.",
    h1: "ميزات دبلجة الفيديو بالذكاء الاصطناعي",
    h1Highlight: "للمبدعين والفرق",
    subtitle:
      "ارفع فيديوك، اختر اللغات، ودع DubSync يتولى استنساخ الصوت ومزامنة الشفاه والترجمة.",
  ...
  id: {
    title: "Fitur DubSync — Kloning Suara, Lip Sync & Dubbing AI",
    description:
      "Jelajahi fitur dubbing AI DubSync: kloning suara, lip sync, 30+ bahasa, deteksi multi-pembicara, dan API.",
    h1: "Fitur dubbing video AI",
    h1Highlight: "untuk kreator dan tim",
    subtitle:
      "Unggah video, pilih bahasa, dan biarkan DubSync menangani kloning suara, lip sync, dan terjemahan.",
  ...
  tr: {
    title: "DubSync Özellikleri — Ses Klonlama, Dudak Senkronu & AI Dublaj",
    description:
      "DubSync AI dublaj özellikleri: ses klonlama, dudak senkronu, 30+ dil, çoklu konuşmacı algılama ve API.",
    h1: "AI video dublaj özellikleri",
    h1Highlight: "üreticiler ve ekipler için",
    subtitle:
      "Videonuzu yükleyin, dilleri seçin ve DubSync'in ses klonlama, dudak senkronu ve çeviriyi halletmesine izin verin.",
  ...
  ko: {
    title: "DubSync 기능 — 음성 클론, 립싱크, AI 더빙",
    description:
      "DubSync AI 더빙 기능: 음성 클론, 립싱크, 30개 이상 언어, 다중 화자 감지, API.",
    h1: "AI 비디오 더빙 기능",
    h1Highlight: "크리에이터와 팀을 위한",
    subtitle:
      "비디오를 업로드하고, 언어를 선택하면 DubSync가 음성 클론, 립싱크, 번역을 처리합니다.",
    ctaPrimary: "무료로 시작",
    ctaPricing: "요금 보기",
    learnMore: "M\u00e1s informaci\u00f3n",
    howItWorks: "C\u00f3mo funciona",
