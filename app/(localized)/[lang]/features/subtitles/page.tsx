...
const TRANSLATIONS = {
  ...
  zh: {
    title: "AI字幕 — 配音视频自动生成",
    description: "为配音音频生成同步AI字幕。内嵌或导出SRT/VTT。所有方案包含。",
    badge: "AI字幕",
    h1: "AI字幕 —",
    h1Highlight: "与每次配音同步",
    subtitle: "DubSync为每个配音视频自动生成同步字幕 — 从配音音频直接生成，而非原始转录。完美同步，内嵌或SRT导出。",
    ctaPrimary: "免费体验AI字幕",
    ctaPricing: "查看价格",
    stats: { languages: "30多种语言", formats: "SRT + VTT", plans: "所有方案" },
    howTitle: "AI字幕工作原理",
    burnedVsSrtTitle: "内嵌 vs SRT — 选择合适的格式",
    burnedVsSrtSubtitle: "两者都包含在每次配音中。为每个渠道选择合适的格式，或同时导出两种。",
    customTitle: "自定义字幕",
    customSubtitle: "开箱即用的合理默认值。需要时完全控制，没有专业视频编辑器的复杂性。",
    useCasesTitle: "适用于所有平台的字幕",
    languagesTitle: "30多种语言的字幕",
    languagesBody: "DubSync配音的每种语言都有完整的字幕支持。RTL语言（阿拉伯语、希伯来语）以正确的RTL格式渲染。CJK语言使用逐字计数。",
    ctaTitle: "为所有平台提供完整字幕视频",
    ctaSubtitle: "5分钟免费开始 — 含字幕。无需信用卡。",
    ctaButton: "免费体验AI字幕",
    faqTitle: "常见问题",
    relatedTitle: "相关功能",
    ...
    allFeatures: "所有功能",
    steps: [
      { title: "配音视频", description: "上传视频，选择语言，运行配音流程。字幕随每次配音自动生成。" },
      { title: "AI转录配音音频", description: "配音后，语音识别在配音音频轨道上运行 — 不是原始转录。" },
      { title: "智能计时和分段", description: "转录被分割为字幕友好的提示：最多2行，每行42字符，1-7秒显示。" },
      { title: "选择输出", description: "社交推送用内嵌字幕，YouTube/LMS用SRT/VTT文件。从同一次配音导出两种格式。" },
    ],
    customization: [
      { title: "字体和大小", description: "无衬线、衬线或等宽字体。根据视频分辨率自动缩放。" },
      { title: "颜色和背景", description: "文字颜色、描边宽度、不透明度控制背景。" },
      { title: "位置和对齐", description: "底部（默认）、顶部或自定义Y偏移。" },
      { title: "语言特定控制", description: "字幕可以匹配配音音频或不同。RTL和CJK完全支持。" },
    ],
    useCases: [
      { title: "YouTube创作者", description: "上传配音视频 + SRT作为字幕轨道。YouTube自动映射，Google SEO索引。", href: "platforms/youtube" },
      { title: "社交媒体（TikTok、Instagram、Facebook）", description: "内嵌字幕必需 — 大多数用户静音观看。样式字幕提升40%参与度。", href: "platforms/tiktok" },
      { title: "在线教育", description: "Udemy、Coursera、Teachable、Thinkific无障碍合规。", href: "platforms/elearning" },
      { title: "企业培训", description: "HR入职、安全、多语言字幕合规。", href: "platforms/elearning" },
    ],
    comparisonRows: [
      { feature: "观众可开关", burned: false, srt: true },
      { feature: "所有平台兼容", burned: true, srt: "partial" },
      { feature: "社交媒体最优", burned: true, srt: false },
      { feature: "YouTube最优", burned: false, srt: true },
      { feature: "导出后可编辑", burned: false, srt: true },
      { feature: "SEO优势", burned: false, srt: true },
      { feature: "文件大小影响", burned: "更大的视频", srt: "小文件" },
    ],
    faqs: [
      { question: "从配音音频生成还是从原始翻译？", answer: "从配音音频。AI转录观众实际听到的内容。" },
      { question: "可以为YouTube导出SRT吗？", answer: "可以。导出SRT或VTT，作为字幕上传。" },
      { question: "免费方案包含吗？", answer: "包含。AI字幕是配音流程的一部分，无额外费用。" },
      { question: "可以自定义外观吗？", answer: "可以。字体、大小、颜色、位置、背景样式。实时预览。" },
      { question: "支持RTL语言吗？", answer: "支持。阿拉伯语、希伯来语等RTL语言完全支持。" },
    ],
  },};
