...
const STRINGS: Record<string, EmailStrings> = {
  ...
  zh: {
    confirmSubject: "确认你的DubSync账户",
    confirmHeading: "验证你的邮箱",
    confirmBody: "点击下方按钮确认你的邮箱地址并激活DubSync账户。",
    confirmButton: "确认邮箱",
    welcomeSubject: "欢迎使用DubSync！🎬",
    welcomeHeading: "欢迎使用DubSync！",
    welcomeBody: "感谢注册！你的第一个视频配音完全免费——上传视频并选择语言即可。我们会自动检测说话者的语言。<br><br>查看控制面板中的演示项目以了解效果。",
    welcomeButton: "前往控制面板",
    dubSubject: "你的配音视频已完成！🎬",
    dubHeading: "视频已完成",
    dubBody: "你的视频配音已完成，可以下载了。点击下方查看结果。",
    dubButton: "查看项目",
    creditsSubject: "你的DubSync额度即将用完",
    creditsHeading: "额度不足",
    creditsBody: "你的配音额度即将用完。请充值或升级方案以继续使用。",
    creditsButton: "获取更多额度",
    footer: "DubSync — AI视频配音",
  },
  tr: {
